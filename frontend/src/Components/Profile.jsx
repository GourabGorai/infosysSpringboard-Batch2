...
export default function Profile() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 px-6 py-10 flex justify-center">
            <div className="w-full max-w-lg">
                <h1 className="text-4xl font-bold text-center mb-10 text-gray-800">My Profile</h1>
